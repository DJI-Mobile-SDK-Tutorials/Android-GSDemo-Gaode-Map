...
你可以从本页面下载到该教程的示例程序, 如果你想有更好的阅读体验，可以浏览我们的[Gitbook](https://dji-dev.gitbooks.io/mobile-sdk-tutorials/content/zh-cn/Android/GSDemo/GSDemo_ch.html)
...
![loadGoogleMap](./Images/loadGaodeMap.png)
...
![locateAircraft](./Images/locateAircraft_cn.png)
...
![addWaypoints](./Images/addWaypoints_cn.png)
...
![clearWaypoints](./Images/clearWaypoints_cn.png)
...
![configButton](./Images/configButton_cn.png)
...
![startGSTask](./Images/startGSTask_cn.png)
